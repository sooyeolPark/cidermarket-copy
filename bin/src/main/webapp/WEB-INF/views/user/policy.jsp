    ...
    <section class="policy_content">
        ...
        <dl class="policy_sub_content"> <dt>1) 거래부적합 아이템</dt>
            <dd>
                ...
                <p> <a href="${pageContext.request.contextPath}/user/terms.cider" id="btnTermsLink" target="_blank">[모든 거래부적합 아이템 보기]</a> </p> <b>※ ‘거래부적합 아이템’은 [아이템 상세&gt;신고하기]를 통해 사이다마켓에 알려주세요.</b> <b>- 자동차 딜러 등 전문판매자 서비스를 제공하는 특정 카테고리는 해당 정책에 따라 운영됩니다.</b>
            </dd>
        </dl>
    </section>
    <section class="policy_content">
