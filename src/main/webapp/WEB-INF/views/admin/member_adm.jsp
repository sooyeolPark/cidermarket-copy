...
<body>
	...
	<script id="board_tmpl" type="x-handlebars-template">
        ...
        <td class="text-center board-group-item">{{phone}}</td>
        ...
        <td class="text-center board-group-item">
			<button type="submit" class="btn btn-warning outmember">{{out}}</button>
        </td>
        </tr>
        {{/boardlist}}
    </script>
	<script id="board_tmpl2" type="x-handlebars-template">
        ...
        <tr>
            ...
            <button type="submit" class="btn btn-warning">{{out}}</button>
            </td>
        </tr>
        {{/boardlist}}
    </script>
	<script type="text/javascript">
	    ...
	    $("#align-number").change(function(){
            ...
            $.get('${pageContext.request.contextPath}/assets/plugins/ajax/member_adm.json', function(req){
