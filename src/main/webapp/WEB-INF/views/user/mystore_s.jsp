  ...
  <section>
    ...
    <div id="mystore">
      ...
      <ul class="nav nav-tabs">
        ...
        <li class="col-sm-4 active"><a href="${pageContext.request.contextPath}/mystore_s.cider">숨긴상품</a></li>
      ...
      <div class="container" id="tab1">
              <div class="item-row clearfix">
                <div id="si_total" class="pull-left">숨긴상품수 <b>${pageData.totalCount}</b></div>
                  <form action="${pageContext.request.contextPath}/mystore_s.cider" method="get">
                  ...
                  <ul>
                    ...
                    <c:choose>
                        ...
                        <c:when test="${pageData.prevPage > 0}">
                            <%-- 이동할 URL 생성 --%>
                            <c:url value="/mystore_s.cider" var="prevPageUrl">
                    ...
                    <c:forEach var="i" begin="${pageData.startPage}" end="${pageData.endPage}" varStatus="status">
                        <%-- 이동할 URL 생성 --%>
                        <c:url value="/mystore_s.cider" var="pageUrl">
                    ...
                    <c:choose>
                        ...
                        <c:when test="${pageData.nextPage > 0}">
                            <%-- 이동할 URL 생성 --%>
                            <c:url value="/mystore_s.cider" var="nextPageUrl">
