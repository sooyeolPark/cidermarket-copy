        ...
        <div class="container">
            ...
            <div id="reg_cont">
                ...
                <div id="item_img1" class="col-xs-3 item-img">
                    <div id=first_img>대표</div><input type="file" id="image0" name="image0" class="image_plus" accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
                <div id="item_img2" class="col-xs-3 item-img"><input type="file" id="image1" name="image1" class="image_plus "
                        accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
                <div id="item_img3" class="col-xs-3 item-img"><input type="file" id="image2" name="image2" class="image_plus "
                        accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
                <div id="item_img4" class="col-xs-3 item-img"><input type="file" id="image3" name="image3" class="image_plus "
                        accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
                <div id="item_img5" class="col-xs-3 item-img"><input type="file" id="image4" name="image4"class="image_plus "
                        accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
                <div id="item_img6" class="col-xs-3 item-img"><input type="file" id="image5" name="image5" class="image_plus "
                        accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
                <div id="item_img7" class="col-xs-3 item-img"><input type="file" id="image6" name="image6" class="image_plus "
                        accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
                <div id="item_img8" class="col-xs-3 item-img"><input type="file" id="image7" name="image7" class="image_plus "
                        accept="image/*" />
                    <a class="remove_img" href="#" title="삭제"><i class="glyphicon glyphicon-remove"></i></a>
                </div>
            </div>
                ...
                <div class="reg_name">상품정보</div>
                    <fieldset>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-10">
                                <input type="text" class="form-control" id="item_subject" name="item_subject" placeholder="상품 제목을 입력해주세요.">
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <input type="hidden" id="item_prodcon" name="item_prodcon" value="N" />
                            <div class="col-sm-10" id="item_con">
                                <button class="btn btn-info btn-list active" data-con="N">새상품</button>
                                <button class="btn btn-info btn-list" data-con="A">거의새것</button>
                                <button class="btn btn-info btn-list" data-con="U">중고</button>
                            </div>
                        </div>
