...
<body>
  ...
  <section>
    ...
    <ul class="nav nav-tabs" id="msg_tabs">
      ...
      <li class="active col-sm-4 out_msg"><a href="${pageContext.request.contextPath}/msgbox/sender.cider">보낸쪽지</a></li>
        ...
        <ul>
        	...
        	<c:choose>
                ...
                <c:when test="${pageData.prevPage > 0}">
                	<%-- 이동할 URL 생성 --%>
                    <c:url value="/msgbox/sender.cider" var="prevPageUrl">
            ...
            <%-- 페이지 번호 (시작 페이지 부터 끝 페이지까지 반복) --%>
               <c:forEach var="i" begin="${pageData.startPage}" end="${pageData.endPage}" varStatus="status">
                  <%-- 이동할 URL 생성 --%>
                  <c:url value="/msgbox/sender.cider" var="pageUrl">
        	...
        	<c:choose>
                ...
                <c:when test="${pageData.nextPage > 0}">
                	<%-- 이동할 URL 생성 --%>
                    <c:url value="/msgbox/sender.cider" var="nextPageUrl">
  ...
  <script type="text/javascript">
    $(function () {		
      ...
      $(".delete").click(function (e) { 		//삭제 버튼을 눌렀을때
        ...
        $.put("${pageContext.request.contextPath}/msgbox/sender_delete",{
          	 "msgno": msgno
            }, function(json){
          	  if(json.rt=="OK"){
          		alert("삭제가 완료되었습니다.");
      ...
      $(".store").click(function (e) { 		//보관 버튼을 눌렀을때
          ...
          $.put("${pageContext.request.contextPath}/msgbox/sender_save",{
            	 "msgno": msgno
              }, function(json){
            	  if(json.rt=="OK"){
            		alert("쪽지가 보관되었습니다.");
