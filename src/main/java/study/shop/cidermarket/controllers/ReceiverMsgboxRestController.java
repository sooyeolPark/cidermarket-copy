...
@RestController
public class ReceiverMsgboxRestController {
   /** WebHelper 주입 */
   // -> import org.springframework.beans.factory.annotation.Autowired;
   ...
   /** 목록 페이지 */
   @RequestMapping(value="/msgbox/receiver", method=RequestMethod.GET)
   ...
   public Map<String, Object> put_save(
      ...
      /** 2) 데이터 저장하기 */
        ...
        try {
         // 데이터 저장 --> 
           msgboxService.editMsgbox_save(input);
