...
/** 멤버 데이터 관리 기능을 제공하기 위한 Service 계층에 대한 구현체 */
// -> import org.springframework.stereotype.Service;
@Slf4j
@Service
public class AdmMemberServiceImpl implements AdmMemberService {
	...
	public List<Member> getMemberList(Member input) throws Exception {
		...
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectList", input);
			if(result == null) {
	...
	public List<Member> getMemberListByAmountAsc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByAmountAsc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByAmountDesc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByAmountDesc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByPayAsc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByPayAsc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByPayDesc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByPayDesc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByJoindateAsc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByJoindateAsc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByJoindateDesc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByJoindateDesc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public int editMember(Member input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.update("MemberMapper.updateOutmember", input);
			if(result == 0) {
	...
	public List<Member> getMemberListByEditdateAsc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByEditdateAsc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByEditdateDesc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByEditdateDesc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByRateAsc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByRateAsc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Member> getMemberListByRateDesc(Member input) throws Exception {
		List<Member> result = null;
		try {
			result = sqlSession.selectList("MemberMapper.adminSelectListByRateDesc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
