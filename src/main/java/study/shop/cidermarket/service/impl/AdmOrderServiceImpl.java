...
public class AdmOrderServiceImpl implements AdmOrderService{
	...
	public int getProductCount(Product input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.selectOne("AdmOrderMapper.ProductSelectCountAll", input);
		} catch (Exception e) {
	...
	public List<Product> getProductList(Product input) throws Exception {
		...
		try {
			result = sqlSession.selectList("AdmOrderMapper.ProductSelectList", input);
			if(result == null) {
	...
	public int editProduct(Product input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.update("AdmOrderMapper.ProductUpdateItem", input);
			if(result == 0) {
	...
	public int deleteProduct(Product input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.delete("AdmOrderMapper.deleteItem", input);
			if(result == 0) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
	...
	public List<Product> getPriceAsc(Product input) throws Exception {
		List<Product> result = null;
		try {
			result = sqlSession.selectList("AdmOrderMapper.getPriceAsc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Product> getPriceDesc(Product input) throws Exception {
		List<Product> result = null;
		try {
			result = sqlSession.selectList("AdmOrderMapper.getPriceDesc", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Product> getHowJ(Product input) throws Exception {
		List<Product> result = null;
		try {
			result = sqlSession.selectList("AdmOrderMapper.getHowJ", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Product> getHowT(Product input) throws Exception {
		List<Product> result = null;
		try {
			result = sqlSession.selectList("AdmOrderMapper.getHowT", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Product> getTradeconJ(Product input) throws Exception {
		List<Product> result = null;
		try {
			result = sqlSession.selectList("AdmOrderMapper.getTradeconJ", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public List<Product> getTradeconW(Product input) throws Exception {
		List<Product> result = null;
		try {
			result = sqlSession.selectList("AdmOrderMapper.getTradeconW", input);
			if(result == null) {
				throw new NullPointerException("result=null");
			}
		} catch (NullPointerException e) {
	...
	public int getHowJCount(Product input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.selectOne("AdmOrderMapper.getHowJCount", input);
		} catch (Exception e) {
			log.error(e.getLocalizedMessage());
			throw new Exception("데이터 조회에 실패했습니다.");
		}
	...
	public int getHowTCount(Product input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.selectOne("AdmOrderMapper.getHowTCount", input);
		} catch (Exception e) {
			log.error(e.getLocalizedMessage());
			throw new Exception("데이터 조회에 실패했습니다.");
		}
	...
	public int getTradeconJCount(Product input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.selectOne("AdmOrderMapper.getTradeconJCount", input);
		} catch (Exception e) {
			log.error(e.getLocalizedMessage());
			throw new Exception("데이터 조회에 실패했습니다.");
		}
	...
	public int getTradeconWCount(Product input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.selectOne("AdmOrderMapper.getTradeconWCount", input);
		} catch (Exception e) {
			log.error(e.getLocalizedMessage());
			throw new Exception("데이터 조회에 실패했습니다.");
		}
