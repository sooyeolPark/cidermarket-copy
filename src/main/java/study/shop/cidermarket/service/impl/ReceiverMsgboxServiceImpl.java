...
@Slf4j
@Service
public class ReceiverMsgboxServiceImpl implements MsgboxService {
	...
	public List<Msgbox> getMsgboxList(Msgbox input) throws Exception {
		...
		try {
			result = sqlSession.selectList("ReceiverMsgboxMapper.selectList", input);
			if(result == null) {
	...
	public int getMsgboxCount(Msgbox input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.selectOne("ReceiverMsgboxMapper.selectCountAll", input);
		} catch (Exception e) {
			log.error(e.getLocalizedMessage());
			throw new Exception("데이터 조회에 실패했습니다.");
		}
	...
	public int addMsgbox(Msgbox input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.insert("ReceiverMsgboxMapper.insertItem", input);
			if(result == 0) {
	...
	public int editMsgbox_save(Msgbox input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.update("ReceiverMsgboxMapper.saveMsg", input);
			if(result == 0) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
	...
	public int editMsgbox_delete(Msgbox input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.update("ReceiverMsgboxMapper.deleteMsg", input);
			if(result == 0) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
	...
	public int deleteMsgbox_now(Msgbox input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.delete("ReceiverMsgboxMapper.deleteItem", input);
			if(result == 0) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
	...
	public int deleteMsgbox_50(Msgbox input) throws Exception {
		int result = 0;
		try {
			result = sqlSession.delete("ReceiverMsgboxMapper.deleteItem2", input);
			if(result == 0) {
				throw new NullPointerException("result=0");
			}
		} catch (NullPointerException e) {
